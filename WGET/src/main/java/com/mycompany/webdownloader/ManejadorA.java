...
public class ManejadorA extends Thread {
    private ManejadorL DescargaLA;
    private URL url;
    static String path = "C:\\Users\\Omar\\Documents\\School\\Aplicaciones para Comunicaciones en Red\\Aplicaciones_Comunicaciones_Red-Practicas\\WGET\\DESCARGAS\\";
    
    public ManejadorA(URL url, ManejadorL DescargaLA){
        this.url = url;
        this.DescargaLA = DescargaLA;
    }
